...
parser.add_argument('--data_dir', type=str, default="../../../data/mc4/0_raw")
parser.add_argument('--output_dir', type=str, default="../../../_temp")
...
def process_file(fp):
    ...
    out_fp = out_dir / fp.with_suffix("").name.replace("json", "txt")
